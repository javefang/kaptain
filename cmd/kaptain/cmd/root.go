...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.kaptain.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".kaptain" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".kaptain")
	}
